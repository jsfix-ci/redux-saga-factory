(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('typescript-fsa-redux-saga'), require('redux-saga/effects')) :
  typeof define === 'function' && define.amd ? define(['exports', 'typescript-fsa-redux-saga', 'redux-saga/effects'], factory) :
  (factory((global.index = {}),global.typescriptFsaReduxSaga,global.effects));
}(this, (function (exports,typescriptFsaReduxSaga,effects) { 'use strict';
  ...
  function baseDecorator(action, wrapper, asyncAction) {
      return function decorator(target, key, descriptor) {
          if (typeof target === "function" && (!key && !descriptor)) {
              if (asyncAction) {
                  target = typescriptFsaReduxSaga.bindAsyncAction(asyncAction)(target);
              }
              ...
              if (typeof original_1 === "function") {
                  ...
                  if (asyncAction) {
                      original_1 = typescriptFsaReduxSaga.bindAsyncAction(asyncAction)(original_1);
                  }
  ...
  ***************************************************************************** */
  ...
  function takeWrapper(action, saga) {
      ...
      return __generator(this, function (_a) {
          switch (_a.label) {
              case 0:
                  return [4 /*yield*/, effects.take(action)];
              case 1:
                  data = _a.sent();
                  return [4 /*yield*/, effects.call(saga, data)];
              case 2:
                  _a.sent();
                  return [3 /*break*/, 0];
